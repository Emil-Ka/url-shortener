...
- **Пишешь в своём репозитории.** Этот файл и папка `boilerplates/` лежат в скачанном шаблоне (`url-shortener-template`). Свой код держишь в отдельном репозитории и копируешь в него boilerplate из шаблона. Как разложить две папки, описано в начале проекта, в разделе «С чего начать».
